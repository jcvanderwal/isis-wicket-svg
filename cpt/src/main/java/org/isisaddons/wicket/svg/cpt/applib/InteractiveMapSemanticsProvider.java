...
public class InteractiveMapSemanticsProvider implements ValueSemanticsProvider<InteractiveMap> {
    ...
    @Override
    public EncoderDecoder<InteractiveMap> getEncoderDecoder() {
        // TODO:
        return new EncoderDecoder<InteractiveMap>() {
            public String toEncodedString(InteractiveMap toEncode) {
                return Base64Serializer.toString(toEncode);
            }

            public InteractiveMap fromEncodedString(String encodedString) {
                return (InteractiveMap) Base64Serializer.fromString(encodedString);
            }
        };
    }
