...
public class SvgWicketAppFixturesService extends FixtureScripts {

    public SvgWicketAppFixturesService() {
        super("org.isisaddons.wicket.svg.fixture.scripts");
    }
    ...
    public Object installFixturesAndReturnFirst() {
        final List<FixtureResult> run = findFixtureScriptFor(SvgWicketAppSetUpFixture.class).run(null);
