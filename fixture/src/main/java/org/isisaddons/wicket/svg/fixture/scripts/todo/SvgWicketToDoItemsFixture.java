...
public class SvgWicketToDoItemsFixture extends FixtureScript {

    private final String user;

    public SvgWicketToDoItemsFixture() {
        this(null);
    }
    public SvgWicketToDoItemsFixture(final String ownedBy) {
        this.user = ownedBy;
    }
    ...
    private SvgWicketToDoItem createToDoItemForUser(
